...
- [ ] 선행 0 core(`19.03.0`, `4.072`)는 시끄러운 건너뜀으로 유지 — 0을 벗기지 않고 모양만
      받으면 `4.072`가 `4.72`보다 위로 정렬되어, 시끄러운 놓침을 조용한 놓침으로 바꿉니다
- [ ] pep440 관용 — 보류. 후보 규칙 둘을 합쳐도 advisory 경계 2건을 살립니다
- [ ] 생태계별 table-driven 케이스, 그 생태계가 공개한 벡터에 대조
...
- [ ] 가장 좁은 공지가 이긴다, 동수면 공지 ID로 결정
- [ ] 요약 추출 — 레코드의 12%가 `□ 개요` 제목을 못 찾고 폴백으로 밀립니다
