...
출발점은 국내 취약점 데이터였습니다 — KISA/KNVD를 일급 provider로 삼는 것. 조사에서 살아남지
못했습니다. KNVD가 발행한 레코드는 전체 173건이고 전부 국내 상용 소프트웨어라, 컨테이너나 소스
트리에 대한 CVE 조인은 사실상 걸리지 않습니다. 약속으로 남겨두는 대신 보류로 기록했습니다.
