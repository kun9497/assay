...
//
// These few lines are duplicated in internal/scancmd's test of the same
// behaviour rather than exported from one place: sharing a test helper across
// packages means putting it in non-test code, which is a worse trade than two
// copies of a five-line syscall.
//
