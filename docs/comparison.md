...
| Azure Linux 3.0 | 254 agree, 23 assay-only, 0 grype-only (2026-08-31) | Was the audit's one real assay gap (106 agree, 140 grype-only): Microsoft's OSV export bot had stalled 2026-03-10 and OSV.dev served the frozen snapshot. D106 moved the family to Microsoft's daily OVAL; the first weekly run after confirms full recovery — assay now 23 ahead of grype, trivy in perfect 277/277 alignment. Both upstreams fixed their pipeline within a day of being notified | **assay ahead** |
