...
| 그중 한 레코드는 평가가 있고 다른 하나는 없음 | 5,423 | 14 |
| 그중 fixed 버전이 다름 | 2,210 (25%) | **0** |

앞의 두 줄은 그대로 성립합니다. 다중 출처는 예외가 아니라 일반적인 경우이고, 출처들이 심각도를
두고 엇갈리는 것은 finding이 견뎌내야 하는 조건입니다.
